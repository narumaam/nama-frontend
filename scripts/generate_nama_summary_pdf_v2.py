...
def generate_nama_pdf():
    # Saving directly to the Desktop for easy access
    desktop_path = os.path.expanduser("~/Desktop/NAMA_Project_Summary_Final.pdf")
    ...
    story.append(Paragraph(
        "A comprehensive Developer Handoff package (DEVELOPER_HANDOFF.md) has been created. "
    ...
    # Build PDF
    doc.build(story)
    print(f"PDF Generated: {desktop_path}")
